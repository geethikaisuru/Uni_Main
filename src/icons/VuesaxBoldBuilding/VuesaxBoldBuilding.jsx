...
export const VuesaxBoldBuilding = ({ className }) => {
  return (
    <svg
      className={`vuesax-bold-building ${className}`}
      fill="none"
      height="24"
      viewBox="0 0 24 24"
      width="24"
    ...
    >
      <path
        className="path"
        d="M10.75 4.64L6.32 2.45C3.93 1.28 1.97 2.47 1.97 5.09V19.93C1.97 21.07 2.92 22 4.08 22H11.5C12.05 22 12.5 21.55 12.5 21V7.41C12.5 6.36 11.71 5.11 10.75 4.64ZM8.97 13.75H5.5C5.09 13.75 4.75 13.41 4.75 13C4.75 12.59 5.09 12.25 5.5 12.25H8.97C9.38 12.25 9.72 12.59 9.72 13C9.72 13.41 9.39 13.75 8.97 13.75ZM8.97 9.75H5.5C5.09 9.75 4.75 9.41 4.75 9C4.75 8.59 5.09 8.25 5.5 8.25H8.97C9.38 8.25 9.72 8.59 9.72 9C9.72 9.41 9.39 9.75 8.97 9.75Z"
        fill="white"
      />
      <path
        className="path"
